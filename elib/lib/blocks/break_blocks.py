    ...
    def cast(self):
        ...
        if self.showbase.rayQueue.getNumEntries() > 0 and self.showbase.isGUIopen == False:
            ...
            if hitObject.getPythonTag("type") == "zombie":
                ...
                print("Il reste",life,"de vie à ENDER GUARDIAN")
                if life > 0:
                    puissance = 2
                    if self.showbase.mods_items.get(self.showbase.selectedBlockType) != None:
                    ...
                    print("Vous avez gagné. Cependant, il vous arrive quelque chose, de terrible. Mais cela, vous ne le remarquer pas... Retours à la V2!")
