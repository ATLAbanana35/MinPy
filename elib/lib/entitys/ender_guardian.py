...
class EnderGen(ShowBase):
    ...
    def spawn(self, x, y, z, id=uuid.uuid4()):
        ...
        self.showbase.zombies[str(id)+"_zombie"] = self.showbase.loader.loadModel("../ressources/3d/models/ender-guardian/ender-guardian.glb")
        self.showbase.zombies[str(id)+"_zombie"].reparentTo(self.showbase.render)
        self.showbase.zombies[str(id)+"_zombie"].setScale(3, 3, 3)
        ...
        self.showbase.zombies[str(id)+"_zombie"].setPythonTag("life", 1000)
        ...
        def zombie_gravity(task):
            ...
            self.showbase.zombies[str(id)+"_zombie"].setH(self.showbase.zombies[str(id)+"_zombie"].getH())
        ...
        taskMgr.add(update_zombie_to_shape, "update_gravity_2")