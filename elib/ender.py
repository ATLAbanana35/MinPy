...
from lib.entitys.ender_guardian import EnderGen
...
class Main(ShowBase):
    def __init__(self):
        ...
        self.JSON_World = self.JSON["elib"]
        self.lib = self.JSON["lib"]
        self.elib = self.JSON["nlib"]
    ...
    "type": "user",
      ...
      "data": {
          ...
          "life": self.userLife
            ...
            self.enitiys.get("User")["pos"]["x"] = 0
            self.enitiys.get("User")["pos"]["y"] = 0
            self.enitiys.get("User")["pos"]["z"] = 6
        ...
        self.zombieGenerator = EnderGen(self)
        ...
        def LaterExecution():
            ...
            self.zombieGenerator.spawn(0, 30, 0)
