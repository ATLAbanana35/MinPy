...
# self.showbase.selectedBlockType)
                self.showbase.timeline_control("cblock", "_IFO_DAT__CBX_"+str(newBlockPos.x)+"_CBX_"+"_CBY_"+str(newBlockPos.y)+"_CBY_"+"_CBZ_"+str(newBlockPos.z)+"_CBZ_"+"_CBT_"+str(self.showbase.selectedBlockType)+"_CBT__IFO_DAT_")
