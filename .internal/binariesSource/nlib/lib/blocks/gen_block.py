...
class GenBlocks(ShowBase):
                ...
                try:
                    ...
                    for z in range(0, 30, 2):
                        ...
                        if random_number == 1:
                            ...
                            self.showbase.print("DONJONS SPAWN!")
                        if z > 10:
                            self.createNewBlock(
                            x,
                            y,
    ...
    def generateTerrain(self):
        ...
        if int(self.showbase.enitiys.get("User")["pos"]["x"]) > -10 and int(self.showbase.enitiys.get("User")["pos"]["y"]) > -10 and int(self.showbase.enitiys.get("User")["pos"]["x"]) < 10 and int(self.showbase.enitiys.get("User")["pos"]["y"]) < 10:
            ...
            posX_1 = -10
            posX_2 = +10
        self.showbase.print("Spawn at : "+str(posX_1)+ str(posX_2)+ str(posY_1)+ str(posY_2))
            ...
            for x in range(posX_1, posX_2, 2):
                try:
                    ...
                    for z in range(0, 30):
                        ...
                        if random_number == 1:
                            self.create_donjon(x,y)
                            self.showbase.print("donjon spawn!")
                        if z > 10:
                            self.createNewBlock(
                            x,
                            y,
    ...
    # Création du so
        ...
        create_room(0, zombieGenerator)
        create_room(5, zombieGenerator)
        create_room(-5, zombieGenerator)
