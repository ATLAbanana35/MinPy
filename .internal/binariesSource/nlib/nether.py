...
class Main(ShowBase):
    def __init__(self):
        ...
        if self.showbase.enitiys.get("User")["data"]["quests"]["0x01111"] == False:
            self.showbase.enitiys.get("User")["data"]["quests"]["0x01111"] = True
            self.showbase.print("Vous avez réussis le succès du Nether!")
